...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void createNewUser(FirebaseUser user){
        ...
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/halochat-45294.appspot.com/o/blank-profile-picture-973461_960_720.png?alt=media&token=adb981be-b017-4117-99e5-fb1c52f45ba1");
